                    ...
                    <form method="post" action="transaksi_update.php">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <div class="form-group alert alert-info">
                                <label>Status</label>
                                <select class="form-control" name="ststus" required="required">

                                    <option <?php if($t['transaksi_ststus']=="0"){echo "selected='selected'";} ?> value="0">PROSES</option>
                                    <option <?php if($t['transaksi_ststus']=="1"){echo "selected='selected'";} ?> value="1">DI CUCI</option>
                                    <option <?php if($t['transaksi_ststus']=="2"){echo "selected='selected'";} ?> value="2">SELESAI</option>
                                </select>
                            </div>
