...
<body style="background: #f0f0f0;">
	...
	if ($_SESSION['ststus']!="login"){
		header("localtion:../index.php?pesan=belum_login");
	}
	?>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="transaksi.php"><i class="glyphicon glyphicon-random"></i>transasksi</a></li>
					<li class="active"><a href="laporan.php"><i class="glyphicon glyphicon-list-alt"></i>Laporan</a></li>

					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aris-expanded="false"><i class="glyphicon glyphicon-wrench"></i>Pengaturan<span class="caret"></span></a>
