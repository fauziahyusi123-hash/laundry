					...
					<div class="panel panel-warning">
						<div class="panel-heading">
							<h1>
								...
								<span class="pull-right">
									<?php
									$proses = mysqli_query($koneksi,"select * from transaksi where transaksi_ststus='0'");
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h1>
								...
								<span class="pull-right">
									<?php
									$proses = mysqli_query($koneksi,"select * from transaksi where transaksi_ststus='1'");
									echo mysqli_num_rows($proses);
								?>
							</span>
						</h1>
					...
					<div class="panel panel-success">
						<div class="panel-heading">
							<h1>
								...
								<span class="pull-right">
									<?php
									$proses = mysqli_query($koneksi,"select * from transaksi where transaksi_ststus='2'");
									echo mysqli_num_rows($proses);
								?>
							</span>
						</h1>
		...
		<table class="table table-bordered table-striped">
			...
			?>
				<tr>
					...
					<td>
						<?php
					       if ($d['transaksi_ststus']==0){
					       	echo "<div class='label label-warning'>PROSES</div>";
					       }elseif ($d['transaksi_ststus']==1){
					       	echo "<div class='label label-info'>DICUCI</div>";
					       }elseif ($d['transaksi_ststus']==2){
